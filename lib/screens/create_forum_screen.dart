    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            icon:Icon(Icons.arrow_back_ios_new, size:32, color: Color(0XFF02084B)),
            )
        ),
              ...
              child:Column(
                ...
                children: [
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Create a Forum", style: TextStyle(color: Color(0XFF02084B), fontSize: 32, fontWeight: FontWeight.bold)),
                    ],
                  ),
                  SizedBox(height: 28),
                  TextField(
                    decoration: InputDecoration(
                      ...
                      hintStyle: TextStyle(color: Color(0XFF02084B).withOpacity(0.3), fontSize: 16, fontWeight: FontWeight.bold),
                  ...
                  SizedBox(height: 28),
                  Text("Categories", style: TextStyle(color: Color(0XFF02084B), fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height:20),
                  Row(
                  ...
                  SizedBox(height: 28),
                  Text("Description", style: TextStyle(color: Color(0XFF02084B), fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height:8),
                  Container(
                    height:120, 
                    child: descriptionForum()),
                  SizedBox(height: 8),
                  Text("Add Media", style: TextStyle(color: Color(0XFF02084B), fontSize: 24, fontWeight: FontWeight.bold)),
                  SizedBox(height:12),
                  Container(
                    height:82,
                    child: Row(
