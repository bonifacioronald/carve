...
class ForumCard extends StatelessWidget {
  ...
  ForumCard(this.name,this.time,this.category, this.title, this.like,this.comments);
        ...
        children:[
            ...
            child:Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child:Center(
                    child:Text(category, style: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.bold)),
                  )
                ...
                SizedBox(width: 12),
                Icon(Icons.bookmark_add_outlined, color: Color(0XFF5B5B5B5B).withOpacity(0.5), size: 28),
          ...
          Container(
            ...
            child:Row(
              ...
              children: [
                Icon(Icons.thumb_up_alt_outlined, color: Color(0XFF5B5B5B5B).withOpacity(0.5), size: 24),
                SizedBox(width: 4),
                Text(like, style: TextStyle(color: Color(0XFF5B5B5B5B).withOpacity(0.5), fontSize: 16, fontWeight: FontWeight.bold)),
                SizedBox(width: 16),
